...
function(){}).then(function(){return a.initialize(c)}).then(function(){return b()}).then(function(a){return a})};h.PDFNet=a})("undefined"===typeof window?this:window);var _=require("underscore");
