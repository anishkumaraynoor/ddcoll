...
module.exports = {
    arrearWork: (data) => {
        ...
        var basicpay = [revpay, first, second, third, fourth, fifth];
        var oldbasicpay = [oldpay, oldfirst, oldsecond, oldthird, oldfourth, oldfifth]
        var oldbasicagp = [oldagp, oldagpfirst, oldagpsecond, oldagpthird, oldagpfourth, oldagpfifth]
        var paydates = [revdate, firstdate, seconddate, thirddate, fourthdate, fifthdate, fifthdate + 31536000000];

        var dadates = [1451520000000, 1467244800000, 1483142400000, 1498780800000, 1514678400000, 1530316800000, 1546214400000, 1561852800000, 1577750400000, 1593475200000, 1609372800000, 1625011200000]
        var das = [0, 2, 4, 5, 7, 9, 12, 17, 21, 24, 24, 24]
